...
return [
    "[...] wprowadziłem ład i spokój do mojej duszy. Jak niemowlę u swej matki, jak niemowlę – tak we mnie jest moja dusza. Izraelu, złóż w Panu nadzieję odtąd i aż na wieki! (Ps 131,2-3)",
    ...
    "«Nie lękaj się, bo cię wykupiłem, wezwałem cię po imieniu; tyś moim! Gdy pójdziesz przez wody, Ja będę z tobą, i gdy przez rzeki, nie zatopią ciebie. Gdy pójdziesz przez ogień, nie spalisz się, i nie strawi cię płomień. Albowiem Ja jestem Pan, twój Bóg, Święty Izraela, twój Zbawca. (Iz 43,1b-3a)",
    "«Pocieszcie, pocieszcie mój lud!» - mówi wasz Bóg. (Iz 40,1)",
    "«Udziel nam rady, podaj wskazówkę, jak w nocy połóż twój cień w samo południe. Ukryj wygnańców, nie zdradź tułaczy! (Iz 16,3)",
    "...i powiesz do niego: \"Uważaj, bądź spokojny, nie bój się!... Niech twoje serce nie słabnie z powodu tych dwóch oto niedopałków dymiących głowni, z powodu zaciekłości Resina, Aramejczyków i syna Remaliasza (Iz 7,4)",
    "...większy jest Ten, który w was jest, od tego, który jest w świecie. (1J 4,4b)",
    ...
    "A jednak, Panie, Ty jesteś dla mnie tarczą, Tyś chwałą moją i Ty mi głowę podnosisz. Wołam swym głosem do Pana, On odpowiada ze świętej swojej góry. (Ps 3,4-5)",
    ...
    "A ktoś poucza go o tym prawie, jego Bóg mu to wykłada. (Iz 28,26)",
    ...
    "A oto gwiazda, którą widzieli na Wschodzie, szła przed nimi, aż przyszła i zatrzymała się nad miejscem, gdzie było Dziecię. Gdy ujrzeli gwiazdę, bardzo się uradowali. (Mt,29b-10)",
    ...
    "A Pan osuszy odnogę Morza Egipskiego gwałtownym swym podmuchem i potrząśnie ręką na Rzekę, i rozdzieli ją na siedem odnóg, tak że ją przejść się da w sandałach. (Iz 11,15)",
    ...
    "A więc raduj się, wesel z powodu synów sprawiedliwych, bo wszyscy będą zgromadzeni i uwielbiać będą Pana wieków, szczęśliwi, którzy cię miłują, i szczęśliwi, którzy się cieszą z twego pokoju. (Tb 13,15)",
    "Ach, Arielu, Arielu, miasto, gdzie obozował Dawid! Dodajcie rok do roku, święta niech biegną swym cyklem! (Iz 29,1)",
    ...
    "Albowiem Pan jest naszym sędzią, Pan naszym prawodawcą, Pan naszym królem! On nas zbawi! (Iz 33,22)",
    ...
    "Albowiem z Jeruzalem wyjdzie Reszta i z góry Syjonu garstka ocalałych. Zazdrosna miłość Pana Zastępów tego dokona. (Iz 37,32)",
    "Ale ja jestem nędzny i zbolały; niech pomoc Twoja, Boże, mię strzeże! Pieśnią chcę chwalić imię Boga i dziękczynieniem Go wysławiać. (Ps 69,30-31)",
    "Ale jak jest napisane o Synu Człowieczym? Ma On wiele cierpieć i być wzgardzonym. (Mk 9,12b)",
    ...
    "Anioł Pana zakłada obóz warowny wokół bojących się Jego i niesie im ocalenie. (Ps 34,8)",
    "Anna modliła się mówiąc: Raduje się me serce w Panu, moc moja wzrasta dzięki Panu, rozwarły się me usta na wrogów moich, gdyż cieszyć się mogę Twoją pomocą. (1Sm 2,1)",
    ...
    "Bądź Bogu wierny, a On zajmie się tobą, prostuj swe drogi i Jemu zaufaj! (Syr 2,6)",
    ...
    "Bądź uwielbiony, Boże ojców naszych, i niech będzie uwielbione imię Twoje na wieki przez wszystkie pokolenia! Niech Cię uwielbiają niebiosa i wszystkie Twoje stworzenia po wszystkie wieki. (Tb 8,5b)",
    "Bądź uwielbiony, ponieważ się zmiłowałeś nad dwoma jedynakami, okaż im, Panie, miłosierdzie i ocal ich! Pozwól im dokończyć życia w szczęściu i w łasce! (Tb 8,17)",
    "Bądźcie miłosierni, jak Ojciec wasz jest miłosierny. (Łk 6,36)",
    "Bądźcie mocni i mężnego serca, wszyscy, którzy pokładacie ufność w Panu! (Ps 31,25)",
    "Bądźcie mocni w Panu - siłą Jego potęgi. Obleczcie pełną zbroję Bożą, byście mogli ostać się wobec podstępnych zakusów diabła. (Ef 6,10-11)",
    "Bądźcie więc wy doskonali, jak doskonały jest Ojciec wasz niebieski. (Mt 5,48)",
    "Będę śpiewał Tobie, Mocy moja, bo Ty, o Boże, jesteś moją warownią, mój łaskawy Boże. (Ps 59,18)",
    "Będzie tam droga czysta, którą nazwą Drogą Świętą. Nie przejdzie nią nieczysty, <gdy odbywa podróż>, i głupi nie będą się tam wałęsać. Nie będzie tam lwa, ni zwierz najdzikszy nie wstąpi na nią ani się tam znajdzie, ale tamtędy pójdą wyzwoleni. (Iz 35,8-9)",
    "Biada tym, którzy się kryją przed Panem, aby zataić swe zamysły, których czyny osnute są cieniem i którzy mówią: «Kto nas zobaczy i kto nas pozna?» (Iz 29,15)",
    ...
    "Błogosławię Pana, który dał mi rozsądek, bo nawet nocami upomina mnie serce. Stawiam sobie zawsze Pana przed oczy, nie zachwieję się, bo On jest po mojej prawicy. (Ps 16,7-8)",
    ...
    "Błogosławiony Pan, Bóg Izraela, od wieków na wieki. (1Krn 16,36)",
    ...
    "Bo góry mogą ustąpić i pagórki się zachwiać, ale miłość moja nie odstąpi od ciebie i nie zachwieje się moje przymierze pokoju, mówi Bóg, który ma litość nad tobą. (Iz 54,10)",
    "bo Jego lud jest własnością Pana, dziedzictwem Jego wydzielonym jest Jakub. Na pustej ziemi go znalazł, na pustkowiu, wśród dzikiego wycia, opiekował się nim i pouczał, strzegł ja źrenicy oka. (Pwt 32,9-10)Jak orzeł, co gniazdo swoje ożywia, nad pisklętami swoimi krąży, rozwija swe skrzydła i bierze je, na sobie samym je nosi- tak Pan sam go prowadził, nie było z nim boga obcego. (Pwt 32,11-12)",
    "Bo któż jest Bogiem prócz Pana? Lub któż jest Skałą prócz Boga naszego? Bóg, co mocą mnie przepasuje i nienaganną czyni moją drogę, On daje moim nogom rączość nóg łani i stawia mnie na wyżynach, On ćwiczy moje ręce do bitwy, a ramiona - do napinania spiżowego łuku. Dajesz mi tarczę Twą dla ocalenia, i wspiera mnie Twoja prawica, a Twoja troskliwość czyni mnie wielkim. Wydłużasz mi kroki na drodze i stopy moje się nie chwieją. (Ps 18,32-37)",
    "Bo Pan Bóg jest słońcem i tarczą: Pan hojnie darzy łaską i chwałą, nie odmawia dobrodziejstw postępującym nienagannie. Panie Zastępów, szczęśliwy człowiek, który ufa Tobie! (Ps 84,12-13)",
    ...
    "bo tchnienie przemożnych jest jak deszcz zimowy, jak spiekota na suchym stepie. Ty uśmierzysz wrzawę pysznych; jak upał cieniem chmury, tak pieśń ciemięzców zostanie stłumiona. (Iz 25,4-5)",
    "Bo też, że człowiek je i pije, i cieszy się szczęściem przy całym swym trudzie - to wszystko dar Boży. (Koh 3,11-13)",
    "Bo Tyś jest ucieczką dla biednych, dla ubogich podporą w utrapieniu; Tyś osłoną przed deszczem, Tyś ochłodą przed skwarem; (Iz 25,4)",
    "Bo wejrzał na uniżenie Służebnicy swojej. Oto bowiem błogosławić mnie będą odtąd wszystkie pokolenia, gdyż wielkie rzeczy uczynił mi Wszechmocny. Święte jest Jego imię (Łk 1,48-49)On Skała, dzieło Jego doskonałe, bo wszystkie drogi Jego są słuszne; On Bogiem wiernym, a nie zwodniczym, On sprawiedliwy i prawy. (Pwt 32,4)",
    "Bo wszyscy bogowie pogan to ułuda, a Pan uczynił niebiosa. (1Krn 16,26)",
    "Bo z wielkości i piękna stworzeń poznaje się przez podobieństwo ich Stwórcę. (Mdr 13,5)",
    "Bo złamałeś jego ciężkie jarzmo i drążek na jego ramieniu, pręt jego ciemięzcy jak w dniu porażki Madianitów (Iz 9,3)",
    ...
    "Bogu memu chcę zaśpiewać pieść nową: Panie, jesteś wielki i przesławny, przedziwny w sile swojej i niezwyciężony. (Jdt 16,13)",
    ...
    "Bóg - Jego droga jest nieskalana, słowo Pana w ogniu wypróbowane; On tarczą dla wszystkich, którzy doń się chronią. (Ps 18,31)",
    "Bóg jest blisko wszystkich, którzy Go wzywają, wszystkich wzywających Go szczerze. (Ps 145,18)",
    ...
    "Bóg jest dobry dla wszystkich i Jego miłosierdzie ogarnia wszystkie Jego dzieła. (Ps 145,9)",
    "Bóg może zlać na was całą obfitość łaski, tak byście mając wszystkiego i zawsze pod dostatkiem, bogaci byli we wszystkie dobre uczynki według tego, co jest napisane: Rozproszył, dał ubogim, sprawiedliwość Jego trwa na wieki. (2 Kor 9,8-9)",
    ...
    "Bóg umacnia kroki człowieka i w jego drodze ma upodobanie. A choćby upadł, to nie będzie leżał, bo rękę jego Bóg podtrzymuje (Ps 37,23-24)",
    "Bóg z tymi, którzy Go miłują współdziała we wszystkim dla ich dobra. (Rz 8,28a)",
    ...
    "Bóg, Ten, który rozkazał ciemnościom, by zajaśniały światłem, zabłysnął w naszych sercach, by olśnić nas jasnością poznania chwały Bożej na obliczu Chrystusa. Przechowujemy zaś ten skarb w naczyniach glinianych, aby z Boga była owa przeogromna moc, a nie z nas. (2 Kor 4,6-7)",
    "Bracia moi, niech wiara wasza w Pana naszego Jezusa Chrystusa uwielbionego nie ma względu na osoby. (Jk 2,1)",
    "Bramy Jerozolimy rozbrzmiewać będą pieśniami wesela, a wszystkie jej domy zawołają: \"Alleluja, niech będzie uwielbiony Bóg Izraela! I błogosławieni będą błogosławić Imię święte na wieki i na zawsze.\" (Tb 13,18)",
    "Cała ziemia odetchnęła uspokojona, szaleje z radości. (Iz 14,7)",
    ...
    "Choćbyście Mnie nie wierzyli, wierzcie moim dziełom, abyście poznali i wiedzieli, że Ojciec jest we Mnie, a Ja w Ojcu. (J 10,38b)",
    ...
    "Chwalcie Pana! Wzywajcie Jego imienia! Rozgłaszajcie Jego dzieła wśród narodów, przypominajcie, że wspaniałe jest imię Jego! Śpiewajcie Panu, bo uczynił wzniosłe rzeczy! Niech to będzie wiadome po całej ziemi! Wznoś okrzyki i wołaj z radości, mieszkanko Syjonu, bo wielki jest pośród ciebie Święty Izraela! (Iz 12,4-6)",
    "Chwalcie Pana! Wzywajcie Jego imienia! Rozgłaszajcie Jego dzieła wśród narodów, przypominajcie, że wspaniałe jest imię Jego! (Iz 12,4b)",
    "Chwalcie Pana, bo dobry, bo na wieki Jego łaskawość. (1Krn 16,34)",
    "Co zaś się odpowie posłom barbarzyńców? - «To, że Pan założył Syjon i do niego się chronią nieszczęśliwi z Jego ludu». (Iz 14,32)",
    ...
    "Cóż bowiem za korzyść stanowi dla człowieka zyskać świat cały, a swoją duszę utracić? (Mk 8,37)",
    "Cóż mam mówić? Wszak On mi powiedział i On to sprawił. Przeżyję spokojnie wszystkie moje lata po chwilach goryczy mej duszy. (Iz 38,15)",
    "Czemu jesteś zgnębiona, moja duszo, i czemu jęczysz we mnie? Ufaj Bogu, bo jeszcze Go będę wysławiać: Zbawienie mego oblicza i mojego Boga. (Księga Psalmów 43,5)",
    ...
    "Czy dotarłeś do źródeł morza? Czy doszedłeś do dna Otchłani? Czy wskazano ci bramy śmierci? Widziałeś drzwi od ciemności? (Hi 38,16-17)",
    "Czy nie wiesz tego? Czyś nie słyszał? Pan - to Bóg wieczny, Stwórca krańców ziemi. On się nie męczy ani nie nuży, Jego mądrość jest niezgłębiona. On dodaje mocy zmęczonemu i pomnaża siły omdlałego. (Iz 40,28-29)",
    "Czy nie wiesz tego? Czyś nie słyszał? Pan - to Bóg wieczny, Stwórca krańców ziemi. On się nie męczy ani nie nuży, Jego mądrość jest niezgłębiona. On dodaje mocy zmęczonemu i pomnaża siły omdlałego. (Iz 40,28-29)",
    "Czy śpi, czy czuwa, we dnie i w nocy, nasienie kiełkuje i rośnie, on sam nie wie jak. Ziemia sama z siebie wydaje plon, najpierw źdźbło, potem kłos, a potem pełne ziarnko w kłosie. (Mk 4,27-28)",
    "Czy trzeba Mu zgłosić: «Chcę mówić»? Musi Mu człowiek powiedzieć, że ginie? (Hi 37,20)",
    "Czyż milsze są dla Pana całopalenia i ofiary krwawe od posłuszeństwa głosowi Pana? (1 Sm 15,22a)",
    ...
    "Daj nam pomoc przeciw nieprzyjacielowi, bo ludzkie ocalenie jest zawodne. W Bogu dokonamy czynów pełnych mocy: i On podepcze naszych nieprzyjaciół. (Ps 60,13-14)",
    ...
    "Dlatego na Wschodzie czcić będą Pana, na wyspach morskich imię Pana, Boga Izraelowego. (Iz 24,15)",
    ...
    "Dlatego tak mówi Pan, Bóg domu Jakuba, który odkupił Abrahama: «Odtąd Jakub nie będzie się rumienił ani oblicze jego już nie przyblednie, bo gdy ujrzy <swe dzieci>, dzieło mych rąk, wśród siebie, ogłosi imię moje jako święte. Wtedy czcić będą Świętego Jakubowego i z bojaźnią szanować Boga Izraela». (Iz 29,22-23)",
    ...
    "Dobry jest Bóg dla ufnych, dla duszy, która Go szuka. Dobrze jest czekać w milczeniu ratunku od Boga. (Lm 3,25-26)",
    "Dobry jesteś i dobrze czynisz; naucz mię Twoich ustaw! (Ps 119,68)",
    "Dołóż starania, byś sam stanął przed Bogiem jako godny uznania pracownik, który nie przynosi wstydu, trzymając się prostej linii prawdy. (2 Tym 2,15)",
    ...
    "Duch i Oblubienica mówią: Przyjdź! A kto usłyszy, niech powie: \"Przyjdź! I kto odczuwa pragnienie, niech przyjdzie, kto chce, niech wody życia darmo zaczerpnie.\" (Ap 22,17)",
    ...
    "Dusza nasza wyczekuje Pana, On jest naszą pomocą i tarczą. W Nim przeto raduje się nasze serce, ufamy Jego świętemu imieniu. (Ps 33,20-21)",
    "Dzieci Izraela, wróćcie do Tego, od którego odstępstwo oddziela was głęboko. Zaiste, owego dnia każdy porzuci swe bożki srebrne i bożyszcza złote, które wam zrobiły grzeszne wasze ręce. (Iz 31,6-7)",
    "Dzieci, nie miłujemy słowem ani językiem, lecz czynem i prawdą. (1J 3,18)",
    ...
    "Gdy rozstał się z nimi, odszedł na górę, aby się modlić. (Mk 6,46)",
    "Gdybym rozdał na jałmużnę całą majętność moją, a ciało wystawił na spalenie, lecz miłości bym nie miał, nic bym nie zyskał. (1Kor 13,3)",
    "Gdzie jednak wzmógł się grzech, tam jeszcze obficiej rozlała się łaska, aby jak grzech zaznaczył swoje królowanie śmiercią, tak łaska przejawiła swoje królowanie przez sprawiedliwość wiodącą do życia wiecznego przez Jezusa Chrystusa, Pana naszego. (Rz 5,20b-21)",
    "Głos się odzywa: «Wołaj!» - I rzekłem: Co mam wołać? - «Wszelkie ciało to jakby trawa, a cały wdzięk jego jest niby kwiat polny. Trawa usycha, więdnie kwiat, gdy na nie wiatr Pana powieje. Prawdziwie, trawą jest naród. Trawa usycha, więdnie kwiat, lecz słowo Boga naszego trwa na wieki». (Iz 40,6-8)",
    ...
    "Gromadźcie sobie skarby w niebie, gdzie ani mól, ani rdza nie niszczą, i gdzie złodzieje nie włamują się i nie kradną. Bo gdzie jest twój skarb, tam będzie i serce twoje. (Mt 6,20-21)",
    "I będzie tak: Ten, kto pozostał żywy na Syjonie, i który się ostał w Jeruzalem, każdy będzie nazwany świętym i wpisany do [Księgi] Życia w Jeruzalem. (Iz 4,3)",
    "I ciebie chce On wybawić z nieszczęść, przed tobą jest dal, nie cieśnina, i stół opływający tłuszczem. (Hi 36,16)",
    "I dałeś swego Ducha dobrego, aby ich oświecał. I manny Twej od ust im nie odjąłeś, i dałeś im wodę, gdy byli spragnieni. (Ne 9,20)",
    ...
    "I dodał: «To szabat został ustanowiony dla dla człowieka, a nie człowiek dla szabatu. Zatem Syn Człowieczy jest panem szabatu». (Mk 2,27-28)",
    ...
    "I jestem pewien, że ani śmierć, ani życie, ani aniołowie, ani Zwierzchności, ani rzeczy teraźniejsze, ani przyszłe, ani Moce, ani co wysokie, ani co głębokie, ani jakiekolwiek inne stworzenie nie zdoła nas odłączyć od miłości Boga, która jest w Chrystusie, Panu naszym. (Rz 8,38-39)",
    "I każdy, kto dla mego imienia opuści dom, braci lub siostry, ojca lub matkę, dzieci lub pole, stokroć otrzyma i życie wieczne odziedziczy. (Mt 19,29)",
    ...
    "I powiedzieli kolejno: \"Amen, amen!\" (Tb 8,8)",
    ...
    "I spraw, aby cały naród i każde pokolenie poznało i wiedziało, że Ty jesteś Bogiem, Bogiem wszelkiej potęgi i mocy, i że nie ma nikogo innego prócz Ciebie, kto by bronił ludu izraelskiego. (Jdt 9,14)",
    "I tam okazywał wam swoją wielkość, wynoście Go pochwałami przed wszystkim, co żyje, ponieważ On sam jest Panem i Bogiem naszym, On sam Ojcem naszym i Bogiem po wszystkie wieki. (Tb 13,4)",
    ...
    "I uchylali się od posłuszeństwa i nie pamiętali o cudach, któreś dla nich uczynił. Byli twardego karku i uwzięli się, by wrócić do niewoli swej w Egipcie. Lecz Ty jesteś Bogiem przebaczenia, jesteś łaskawy i miłosierny, cierpliwy i wielkiej dobroci; i nie opuściłeś ich. (Ne 9,17)",
    ...
    "I wezmę sobie prawo za miarę, a sprawiedliwość za pion. (Iz 28,17)",
    ...
    "Izraelu, tyś szczęśliwy, któż tobie podobny? Narodzie, zbawiony przez Pana, Obrońca twój tobie pomaga, błogosławi zwycięski twój miecz. Wrogowie słabną przed tobą, ty zaś wyniosłość ich depczesz. (Pwt 33,29)",
    "Ja go wybawię, bo przylgnął do Mnie; osłonię go, bo uznał moje imię. Będzie Mnie wzywał, a Ja go wysłucham i będę z nim w utrapieniu, wyzwolę go i sławą obdarzę. (Ps 91,14-1)",
    "Ja go wybawię, bo przylgnął do Mnie; osłonię go, bo uznał moje imię. Będzie Mnie wzywał, a Ja go wysłucham i będę z nim w utrapieniu, wyzwolę go i sławą obdarzę. (Ps 91,14-15)",
    ...
    "Ja jestem Pan, i nie ma innego. Poza Mną nie ma Boga. (Iz 45,5a)",
    ...
    "Ja was chrzczę wodą dla nawrócenia; lecz Ten, który idzie za mną, mocniejszy jest ode mnie; ja nie jestem godzien nosić mu sandałów. On was będzie chrzcić będzie Duchem Świętym i ogniem. (Mt 3,11)",
    "Ja zaś jak oliwka, co kwitnie w domu Bożym, zaufam na wieki łaskawości Boga. Chcę Cię wysławiać na wieki za to, coś uczynił, i polegać na Twoim imieniu, bo jest dobre dla ludzi Tobie oddanych. (Ps 52,10-11)",
    ...
    "Ja zaś pokładam ufność w Tobie, Panie, mówię: «Ty jesteś moim Bogiem». W Twoim ręku są moje losy: wyrwij mnie z ręki mych wrogów i prześladowców! (Ps 31,15-16)",
    ...
    "Ja, Pan, tylko Ja istnieję i poza Mną nie ma żadnego zbawcy. To Ja zapowiedziałem, wyzwoliłem i obwieściłem, a nie ktoś obcy wśród was. Wy jesteście świadkami moimi - wyrocznia Pana - że Ja jestem Bogiem, owszem, od wieczności Nim jestem. I nikt się nie wymknie z mej ręki. Któż może zmienić to, co Ja zdziałam? (Iz 43,11-13)",
    ...
    "Jak niedawno narodzone niemowlęta pragnijcie duchowego, niesfałszowanego mleka, abyście dzięki niemu wzrastali ku zbawieniu – jeżeli tylko zasmakowaliście, że słodki jest Pan. (1P 2,2-3)",
    "Jak wam się zdaje? Jeśli kto posiada sto owiec i zabłąka się jedna z nich: czy nie zostawi dziewiędziesięciu dziewięciu na górach i nie pójdzie szukać tej, która się zabłąkała? (Mt 18,12)",
    "Jako dobrzy szafarze różnorakiej łaski Bożej służcie sobie nawzajem tym darem, jaki każdy otrzymał,/.../aby we wszystkim był uwielbiony Bóg przez Jezusa Chrystusa. (1P 4,10-11)",
    "Jako dobrzy szafarze różnorakiej łaski Bożej służcie sobie wzajemnie tym darem, jaki każdy otrzymał. Jeżeli kto ma [dar] przemawiania, niech to będą jakby słowa Boże. Jeżeli kto pełni posługę, niech to czyni mocą, której Bóg udziela, aby we wszystkim był uwielbiony Bóg przez Jezusa Chrystusa. Jemu chwała i moc na wieki wieków! Amen. (1P 4,10-11)",
    ...
    "Jakże jest wielka, o Panie, Twoja dobroć, którą zachowujesz dla tych, co się boją Ciebie, i okazujesz tym, co w Tobie szukają ucieczki na oczach synów ludzkich. (Ps 31,20)",
    "Jam jest chleb życia. Kto do Mnie przychodzi, nie będzie łaknął; a kto we Mnie wierzy, nigdy pragnąć nie będzie. (J 6,35b)",
    "Jedli do sytości, a pozostałych ułomków zebrali siedem koszów. Było zaś około czterech tysięcy ludzi. Potem ich odprawił. (Mk 8,8-9)",
    "Jestem bowiem świadomy zamiarów, jakie zamyślam co do was – wyrocznia Boga – zamiarów pełnych pokoju, a nie zguby, by zapewnić wam przyszłość, jakiej oczekujecie. (Jr 29,11)",
    ...
    "Jesteś blisko, o Panie, i wszystkie Twoje przykazania są prawdą. (Ps 119,151)",
    "Jesteś moim Bogiem, chcę Ci dziękować: Boże mój, chcę Ciebie wywyższać. Wysławiajcie Pana, bo dobry; bo łaska Jego na wieki. (Ps 118,29-28)",
    ...
    "Jeżeli Bóg z nami, któż przeciwko nam? On, który nawet własnego Syna nie oszczędził, ale Go za nas wydał jakże miałby wraz z Nim i wszystkiego nam nie darować? (Rz 8,31b-32)",
    "Jeżeli Bóg z nami, któż przeciwko nam? On, który nawet własnego Syna nie oszczędził, ale Go za nas wydał jakże miałby wraz z Nim i wszystkiego nam nie darować? (Rz 8,31b-32)",
    "Jeżeli Bóg z nami, któż przeciwko nam? On, który nawet własnego Syna nie oszczędził, ale Go za nas wydał jakże miałby wraz z Nim i wszystkiego nam nie darować? (Rz 8,31b-32)",
    "Jeżeli Bóg z nami, któż przeciwko nam? On, który nawet własnego Syna nie oszczędził, ale Go za nas wydał jakże miałby wraz z Nim i wszystkiego nam nie darować? (Rz 8,31b-32)",
    ...
    "Kiedy ktoś zwraca się do Pana, zasłona opada. Pan zaś jest Duchem, a gdzie jest Duch Pański - tam wolność. My wszyscy z odsłoniętą twarzą wpatrujemy się w jasność Pańską jakby w zwierciadle; za sprawą Ducha Pańskiego, coraz bardziej jaśniejąc, upodabniamy się do Jego obrazu. (2 Kor 3,16-18)",
    "Królestwo Boże to nie sprawa tego, co się je i pije, ale to sprawiedliwość, pokój i radość w Duchu Świętym. (Rz 14,17)",
    "Królestwo Boże to nie sprawa tego, co się je i pije, ale to sprawiedliwość, pokój i radość w Duchu Świętym. (Rz 14,17)",
    "Królestwo Boże to nie sprawa tego, co się je i pije, ale to sprawiedliwość, pokój i radość w Duchu Świętym. (Rz 14,17)",
    "Kto bowiem chce miłować życie i oglądać dni szczęśliwe, niech wstrzyma język od złego i wargi, aby nie mówić podstępnie. Niech zaś odstąpi od złego, a czyni dobrze, niech szuka pokoju i niech idzie za nim. (1P 3,10-11)",
    "Kto chce znaleźć swe życie, straci je. A kto straci swe życie z mego powodu, znajdzie je. (Mt 10,39)",
    "Kto hojnie sieje, ten hojnie też zbierać będzie. (2Kor 9,6b)",
    ...
    "Kto przebywa w pieczy Najwyższego i w cieniu Wszechmocnego mieszka, mówi do Pana: «Ucieczko moja i Twierdzo, mój Boże, któremu ufam». Bo On sam cię wyzwoli z sideł myśliwego i od zgubnego słowa. Okryje cię swymi piórami i schronisz się pod Jego skrzydła: Jego wierność to puklerz i tarcza. (Ps 91,1-4)",
    "Kto przebywa w pieczy Najwyższego i w cieniu Wszechmocnego mieszka, mówi do Pana: «Ucieczko moja i Twierdzo, mój Boże, któremu ufam». Bo On sam cię wyzwoli z sideł myśliwego i od zgubnego słowa. Okryje cię swymi piórami i schronisz się pod Jego skrzydła: Jego wierność to puklerz i tarcza. (Ps 91,1-4)",
    "Kto przebywa w pieczy Najwyższego i w cieniu Wszechmocnego mieszka, mówi do Pana: Ucieczko moja i Twierdzo mój Boże, któremu ufam. Bo On sam cię wyzwoli z sideł myśliwego i od zgubnego słowa. (Ps 91,1-3)",
    ...
    "Kto się boi Pana, otrzyma wychowanie, a którzy od wczesnego rana Go szukają, znajdą [Jego] upodobanie. (Syr 32,14)",
    "Kto służy Bogu, z upodobaniem będzie przyjęty, a błaganie jego dosięgnie obłoków. Modlitwa biednego przeniknie obłoki i nie ustanie, aż dojdzie do celu. (Syr 35,16)",
    "Kto spożywa moje Ciało i Krew moją pije, trwa we Mnie, a Ja w nim. (J 6,56)",
    "Kto spożywa moje Ciało i pije moją Krew, ma życie wieczne, a Ja go wskrzeszę w dniu ostatecznym. (J 6,54)",
    "Kto szuka prawości, dobroci, ten znajdzie życie, powodzenie i chwałę. (Prz 21,21)",
    "Kto szuka prawości, dobroci, ten znajdzie życie, powodzenie i chwałę. (Prz 21,21)",
    "Kto szuka prawości, dobroci, ten znajdzie życie, powodzenie i chwałę. (Prz 21,21)",
    ...
    "Kto zaś zachowuje Jego naukę, w tym naprawdę miłość Boża jest doskonała. Po tym właśnie poznajemy, że jesteśmy w Nim. Kto twierdzi, że w Nim trwa, powinien również sam postępować tak, jak On postępował. (1P 2,5-6)",
    ...
    "Ku Tobie, Panie, wznoszę moją duszę, mój Boże, Tobie ufam: niech nie doznam zawodu! Niech moi wrogowie nie triumfują nade mną! Nikt bowiem, kto Tobie ufa, nie doznaje wstydu; doznają wstydu ci, którzy łamią wiarę dla marności. (Ps 25,1-2)",
    "Ku wolności wyswobodził nas Chrystus. A zatem trwajcie w niej i nie poddawajcie się na nowo pod jarzmo niewoli. (Gal 5,1)",
    "Lecz ci, co zaufali Bogu, odzyskują siły, otrzymują skrzydła jak orły: biegną bez zmęczenia, bez znużenia idą. (Iz 40,31)",
    ...
    "Lepiej się uciec do Boga, niż pokładać ufność w człowieku. Lepiej się uciec do Boga, niżeli zaufać książętom. (Ps 118,8-9)",
    "Lepiej się uciec do Pana, niż pokładać ufność w człowieku. Lepiej się uciec do Pana, niżeli zaufać książętom. (Ps 118,8-9)",
    "Lepiej się uciec do Pana, niż pokładać ufność w człowieku. Lepiej się uciec do Pana, niżeli zaufać książętom. (Ps118,8-9)",
    ...
    "Łaska, miłosierdzie i pokój Boga Ojca i Jezusa Chrystusa, Syna Ojca, [niech] będą z nami w prawdzie i miłości! (2J 1,3)",
    "Łaską bowiem jesteście zbawieni przez wiarę. A to pochodzi nie od was, lecz jest darem Boga: nie z uczynków, aby się nikt nie chlubił. Jesteśmy bowiem Jego dziełem, stworzeni w Chrystusie dla dobrych czynów, które Bóg z góry przygotował, abyśmy je pełnili. (Ef 2,8-10)",
    "Łuk mocarzy się łamie, a słabi przepasują się mocą, za chleb najmują się syci, a głodni już odpoczywają, niepłodna rodzi siedmioro, a wielodzietna więdnie. (1Sm 2,4-5)",
    ...
    "Miej ufność w Bogu i postępuj dobrze, mieszkaj w ziemi i zachowaj wierność. Raduj się w Bogu, a On spełni pragnienia twego serca. (Ps 37,3-4)",
    ...
    "Miej ufność w Panu i postępuj dobrze, mieszkaj w ziemi i zachowaj wierność. Raduj się w Panu, a On spełni pragnienia twego serca. (Ps 37,3-4)",
    "Miej ufność w Panu i postępuj dobrze, mieszkaj w ziemi i zachowaj wierność. Raduj się w Panu, a On spełni pragnienia twego serca. (Ps 37,3-4)",
    "Miłosierdzie człowieka - nad jego bliźnim, a miłosierdzie Pana - nad całą ludzkością. (Syr 18,13a)",
    ...
    "Miłość zaś polega na tym, abyśmy postępowali według Jego przykazań. (2J 6)",
    "Miłuję Cię, Panie, Mocy moja, Panie, ostojo moja i twierdzo, mój wybawicielu, Boże mój, skało moja, na którą się chronię, tarczo moja, mocy zbawienia mego i moja obrono! (Ps 18,1-2)",
    ...
    "Mówcie: \"Ratuj nas, Boże zbawienia naszego, zgromadź nas i wybaw spośród narodów, abyśmy wielbili święte imię Twoje i dumni byli z Twej chwały\" (1Krn 16,35)",
    ...
    "Na słowa Pana powstały dzieła Jego. Jak słońce świecąc patrzy na wszystkie rzeczy, tak chwała Pana napełniła Jego dzieło. (Syr,42,15b-16)",
    ...
    "Na wieki pamięta o swoim przymierzu - obietnicę dał dla tysiąca pokoleń. Zawarł je z Abrahamem i przysięgę dał Izaakowi. Ustanowił dla Jakuba jako prawo wieczne przymierze dla Izraela (1Krn 16,15-17)",
    ...
    "Nabierzcie ducha i podnieście głowy, ponieważ zbliża się wasze odkupienie. (Łk 21,28b)",
    ...
    "Nadzieją twą będzie Wszechmocny, obrócisz wzrok twój na Boga, wezwiesz Go, a On cię wysłucha (Hi 22,26-27a)",
    ...
    "Napadają na mnie w dzień dla mnie złowrogi, lecz Pan jest moją obroną, wyprowadza mnie na miejsce przestronne; ocala, bo mnie miłuje. (Ps 18,19-20)",
    "Naród kroczący w ciemnościach ujrzał światłość wielką; nad mieszkańcami kraju mroków światło zabłysło. (Iz 9,1)",
    "Nastawcie uszu i słuchajcie głosu mego, uważajcie i słuchajcie mej mowy! (Iz 28,23)",
    "Naucz mię, Panie, Twej drogi, bym postępował według Twojej prawdy; skłoń moje serce ku bojaźni Twojego imienia! Będę Cię chwalił, Panie, mój Boże, z całego serca mojego i na wieki będę sławił Twe imię, bo wielkie było dla mnie Twoje miłosierdzie i życie moje wyrwałeś z głębin Szeolu. (Ps 86,11-13)",
    "Naucz mnie, Panie, drogi Twoich ustaw, bym strzegł ich aż do końca. (Ps 119,33)",
    "Nic nie znaczy ten, który sieje, ani ten, który podlewa, tylko Ten, który daje wzrost – Bóg. (1Kor 3,7)",
    "Nie bój się, dziecko, żeśmy zbiednieli. Ty masz wielkie bogactwa, jeśli ty Boga się będziesz bał i będziesz unikał każdego grzechu, i czynił, co dobre jest przed Panem, Bogiem twoim. (Tb 4,21)",
    "Nie bój się, dziecko, żeśmy zbiednieli. Ty masz wielkie bogactwa, jeśli ty Boga się będziesz bał i będziesz unikał każdego grzechu, i czynił, co dobre jest przed Panem, Bogiem twoim. (Tb 4,21)",
    ...
    "Nie czuję gniewu. Niech Mi kto sprawi [w niej] ciernie i głogi! Wypowiem mu wojnę, spalę je wszystkie razem! Albo raczej niech się uchwyci mojej opieki, i zawrze pokój ze Mną, pokój ze Mną niech zawrze! (Iz 27,4-5)",
    "Nie daj się zwyciężyć złu, ale zło dobrem zwyciężaj! (Rz 12,21)",
    "Nie dał nam Bóg ducha bojaźni, ale mocy i miłości, i trzeźwego myślenia. Nie wstydź się zatem świadectwa Pana naszego /.../ ale weź udział w trudach i przeciwnościach znoszonych dla Ewangelii według mocy Boga! (2Tm 1,7-8)",
    ...
    "Nie obawiaj się, jeśli ktoś się wzbogaci, jeżeli wzrośnie zamożność jego domu: bo kiedy umrze, nic z sobą nie weźmie, a jego zamożność nie pójdzie za nim. (Ps 49,17-18)",
    "Nie obawiaj się, jeśli ktoś się wzbogaci, jeżeli wzrośnie zamożność jego domu: bo kiedy umrze, nic z sobą nie weźmie, a jego zamożność nie pójdzie za nim. (Ps 49,17-18)",
    ...
    "Nie poddajemy się zwątpieniu, chociaż bowiem niszczeje nasz człowiek zewnętrzny, to jednak ten, który jest wewnątrz, odnawia się z dnia na dzień. Niewielkie bowiem utrapienia nasze obecnego czasu gotują bezmiar chwały przyszłego wieku. (2Kor 4,16-17)",
    "Nie samym chlebem żyje człowiek, lecz każdym słowem, które pochodzi z ust Bożych. (Mt 4,4)",
    "Nie się nie trwoży serce wasze. Wierzycie w Boga? I we Mnie wierzcie! W domu Ojca mojego jest mieszkań wiele. Gdyby tak nie było, to bym wam powiedział. Idę więc przygotować wam miejsce. (J 14,1-2)",
    "Nie spadnie zło na bojącego się Pana, a jeśli będzie doświadczany, dozna wybawienia. Człowiek mądry nie będzie nienawidził Prawa, ale kto obłudnie wobec niego postępuje, jest jak okręt w czasie burzy. (Syr 33,1-2)",
    ...
    "Nie troszczcie się zbytnio o życie, co macie jeść, ani o ciało, czym macie się przyodziać. Życie bowiem więcej znaczy niż pokarm, a ciało więcej niż odzienie. (Łk 12,22b-23)",
    "Nie wyczerpała się litość Boga, miłość nie zgasła. Odnawia się ona co rano: ogromna Twa wierność. «Działem mym Pan» - mówi moja dusza, dlatego czekam na Niego. (Lm 3,22-24)",
    "Nie wyczerpała się litość Pana, miłość nie zgasła. Odnawia się ona co rano: ogromna Twa wierność. «Działem mym Pan» - mówi moja dusza, dlatego czekam na Niego. (Lm 3,22-24)",
    "Nie wyczerpała się litość Pana, miłość nie zgasła. Odnawia się ona co rano: ogromna Twa wierność. «Działem mym Pan» - mówi moja dusza, dlatego czekam na Niego. (Lm 3,22-24)",
    "Nie wyczerpała się litość Pana, miłość nie zgasła. Odnawia się ona co rano: ogromna Twa wierność. «Działem mym Pan» - mówi moja dusza, dlatego czekam na Niego. (Lm 3,22-24)",
    "Nie wydawaj duszy swej smutkowi ani nie dręcz siebie myślami. Radość serca jest życiem człowieka, a wesołość męża przedłuża dni jego. (Syr 30,21-22)",
    "Nie wydawaj duszy swej smutkowi ani nie dręcz siebie myślami. Radość serca jest życiem człowieka, a wesołość męża przedłuża dni jego. (Syr 30,21-22)",
    ...
    "Niebiosa, słuchajcie, ziemio, nadstaw uszu, bo Pan przemawia:  (Iz 1,2)",
    ...
    "Niech Ci służy wszelkie Twoje stworzenie, bo Ty rzekłeś i stało się. Tyś posłał Twego ducha, a on zbudował wszystko, i nie ma nikogo, kto by się sprzeciwił Twemu głosowi. (Jdt 16,14)",
    "Niech cieszy się niebo i ziemia raduje. Mówcie wśród pogan: \"Pan jest królem. Niech szumi morze i co je napełnia, niech się weselą pola i wszystko, co na nich.\" (1Krn 16,31-32)",
    "Niech cię w podziw nie wprawiają czyny grzesznika, ufaj Bogu i wytrwaj w twym trudzie, albowiem łatwą jest rzeczą w oczach Pana natychmiast i niespodziewanie wzbogacić ubogiego. Błogosławieństwo Pana nagrodą bogobojnych i prędko zakwitnie Jego błogosławieństwo. (Syr 11,21-22)",
    "Niech cię w podziw nie wprawiają czyny grzesznika, ufaj Panu i wytrwaj w twym trudzie, albowiem łatwą jest rzeczą w oczach Pana natychmiast i niespodziewanie wzbogacić ubogiego. Błogosławieństwo Pana nagrodą bogobojnych i prędko zakwitnie Jego błogosławieństwo. (Syr 11,21-22)",
    "Niech każdy ma na oku nie tylko swoje własne sprawy, ale też i drugich! (Flp 2,4)",
    "Niech moc Jego chwały w pełni was umacnia do [okazywania] wszelkiego rodzaju cierpliwości i stałości. Z radością dziękujcie Ojcu, który was uzdolnił do uczestnictwa w dziale świętych w światłości. (Kol 1,10-11)",
    "Niech nas ogarnie łaska Twoja Panie, według ufności pokładanej w Tobie! (Ps 33,22)",
    "Niech Pan będzie ucieczką dla uciśnionego, ucieczką w czasach utrapienia. Ufają Tobie znający Twe imię, bo nie opuszczasz, Panie, tych, co Cię szukają. (Ps 9,10-11)",
    ...
    "Niech się raduje dusza wasza w miłosierdziu Pana i nie wstydźcie się Jego chwały! Wypełnijcie dzieło wasze przed czasem, a da wam nagrodę w porze oznaczonej. (Syr 51,29-30)",
    "Niech się raduje dusza wasza w miłosierdziu Pana i nie wstydźcie się Jego chwały! (Syr 51,29)",
    "Niech się rozweselą pustynia i spieczona ziemia, niech się raduje step i niech rozkwitnie! Niech wyda kwiaty jak lilie polne, niech się rozraduje, skacząc i wykrzykując z uciechy. Chwałą Libanu ją obdarzono, ozdobą Karmelu i Saronu. Oni zobaczą chwałę Pana, wspaniałość naszego Boga. (Iz 35,1-2)",
    ...
    "Niemowlę igrać będzie na norze kobry, dziecko włoży swą rękę do kryjówki żmii. (Iz 11,8)",
    "Nieście ofiary i wchodźcie przed Jego oblicze, oddajcie pokłon Panu, w święte szaty odziani. (1Krn 16,29)",
    ...
    "Nikt nie może dwom panom służyć. Bo albo jednego będzie nienawidził, a drugiego będzie miłował; albo z jednym będzie trzymał, a drugim wzgardzi. Nie możecie służyć Bogu i Mamonie. (Mt 6,24)",
    "Nikt siebie samego nie może wykupić ani nie uiści Bogu ceny swego wykupu - jego życie jest zbyt kosztowne i nie zdarzy się to nigdy - by móc żyć na wieki i nie doznać zagłady. (Ps 49,8-10)",
    ...
    "Oby rozradował w tobie pojmanych i umiłował w tobie wszystkich nieszczęśliwych we wszystkich pokoleniach na wieki. (Tb 13,12)",
    "Oczekuję Pana, który ukrywa swe oblicze przed domem Jakuba, i w Nim pokładam nadzieję. (Iz 8,17)",
    "Oczy Pana zwrócone są ku sprawiedliwym, a Jego uszy na ich wołanie. Wołali, a Pan ich wysłuchał i uwolnił od wszystkich przeciwności. (Ps 34,16-17)",
    ...
    "On kocha swój lud. Wszyscy Jego święci są w Jego ręku. U nóg Twoich oni usiedli, słowa Twoje przyjmują. (Pwt 33,3)",
    "On krople wody podnosi i mgłę na deszcz skrapla, (Hi 36,27)",
    ...
    "On sprawia, że słońce Jego wschodzi nad złymi i nad dobrymi, i On zsyła deszcz na sprawiedliwych i niesprawiedliwych. Jeśli bowiem miłujecie tych, którzy was miłują, cóż za nagrodę mieć będziecie? Czyż i celnicy tego nie czynią? (Mt 5,45b-46)",
    "On wstał, rozkazał wichrowi i rzekł do jeziora: «Milcz, ucisz się!» Wicher się uspokoił i nastała głęboka cisza. (Mk 4,39)",
    "On zbadał przepaści i serca ludzkie i wszystkie ich knowania poznał, albowiem Najwyższy posiada całą wiedzę i przewiduje najdalszą przyszłość. (Syr 42,18)",
    "Oni zlękli się bardzo i mówili jeden do drugiego: «Kim On jest, że nawet wicher i jezioro są Mu posłuszne?» (Mk 4,41)",
    "Osłaniaj ich, niech cieszą się Tobą, ci, którzy imię Twe miłują. Bo Ty, Panie, będziesz błogosławił sprawiedliwemu: otoczysz go łaską jak tarczą. (Ps 5,12b-13)",
    ...
    "Oto król będzie panował sprawiedliwie i książęta rządzić będą zgodnie z prawem; każdy będzie jakby osłoną przed wichrem i schronieniem przed ulewą, jak strumienie wody na suchym stepie, jak cień olbrzymiej skały na spieczonej ziemi. (Iz 32,1-2)",
    "Oto na zdrowie zamienił mi gorycz. Ty zachowałeś mą duszę od dołu unicestwienia, gdyż poza siebie rzuciłeś wszystkie moje grzechy. (Iz 38,17)",
    ...
    "Otoczę opieką to miasto i ocalę je, przez wzgląd na Mnie i na sługę mego Dawida. (Iz 37,35)",
    ...
    "Owego dnia człowiek wyrzuci kretom i nietoperzom bożki swe srebrne i bałwany złote, zrobione po to, by im cześć oddawał (Iz 2,20)",
    ...
    "Owego dnia to się stanie: Pan podniesie po raz drugi rękę, aby wykupić Resztę swego ludu, która ocaleje, z Asyrii i z Egiptu, z Patros i z Kusz, z Elamu i Szinearu, z Chamat i z wysp na morzu. (Iz 11,11)",
    ...
    "Pamiętaj, dziecko, na Boga przez wszystkie dni twoje! Nie popełniaj dobrowolnie grzechu i nie przestępuj nigdy Jego przykazań! Przez wszystkie dni twojego życia spełniaj uczynki miłosierne i nie chodź drogami nieprawości, ponieważ ci, którzy właściwie postępują, doznają powodzenia we wszystkich swych czynach. (Tb 4,5-6)",
    "Pamiętaj, dziecko, na Pana przez wszystkie dni twoje! Nie popełniaj dobrowolnie grzechu i nie przestępuj nigdy Jego przykazań! Przez wszystkie dni twojego życia spełniaj uczynki miłosierne i nie chodź drogami nieprawości, ponieważ ci, którzy właściwie postępują, doznają powodzenia we wszystkich swych czynach. (Tb 4,5-6)",
    "Pan - to Bóg wieczny, Stwórca krańców ziemi. On się nie męczy ani nie nuży, Jego mądrość jest niezgłębiona. On dodaje mocy zmęczonemu i pomnaża siły omdlałego. (Iz 40,28-29)",
    "Pan cierpliwy jest dla ludzi i wylał na nich swoje miłosierdzie. Zobaczył On i wie, że koniec ich godny litości i dlatego pomnożył swoje przebaczenie. (Syr 18,11-12)",
    "Pan częścią dziedzictwa i kielicha mego: To właśnie Ty mój los zabezpieczasz.Sznur mierniczy wyznaczył mi dział wspaniały i bardzo mi jest miłe to moje dziedzictwo. (Ps 16,5-6)",
    ...
    "Pan jest wierny we wszystkich swych słowach i we wszystkich swoich dziełach święty. (Ps 145,13b)",
    "Pan mi powiedział: «Wystarczy ci mojej łaski. Moc bowiem w słabości się doskonali.» (2 Kor12,9)",
    "Pan mnie zachowuje! Więc grać będziemy me pieśni na strunach przez wszystkie dni naszego życia w świątyni Pańskiej. (Iz 38,20)",
    ...
    "Pan uwalnia dusze sług swoich, nie dozna kary, kto się doń ucieka. (Ps 34,23)",
    "Pan uwalnia dusze sług swoich, nie dozna kary, kto się doń ucieka. (Ps 34,23)",
    ...
    "Pan, Bóg twój, wprowadzi cię do ziemi pięknej, ziemi obfitującej w potoki, źródła i strumienie, które tryskają w dolinie oraz na górze - do ziemi pszenicy, jęczmienia, winorośli, drzewa figowego i granatowego - do ziemi oliwek, oliwy i miodu. (Pwt 8,7-8)",
    "Panie, Boże nasz, inni panowie niż Ty nas opanowali, ale my Ciebie samego, Twoje imię wysławiamy. (Iz 26,13)",
    "Panie, do Ciebie się uciekam, niech nigdy nie doznam zawodu; wybaw mnie w Twojej sprawiedliwości! Skłoń ku mnie ucho, pośpiesz, aby mnie ocalić. Bądź dla mnie skałą mocną, warownią, aby mnie ocalić. (Ps 31,2-3)",
    "Panie, naucz mnie Twojej drogi, prowadź mnie ścieżką prostą, ze względu na mych wrogów! (Ps 27,11)",
    ...
    "Panie, przenikasz i znasz mnie, Ty wiesz, kiedy siadam i wstaję. Z daleka przenikasz moje zamysły, widzisz moje działanie i mój spoczynek i wszystkie moje drogi są Ci znane. (Ps 139,2-3)",
    "Panie, Tyś Bogiem moim! Sławić Cię będę i wielbić Twe imię, bo dokonałeś przedziwnych zamierzeń z dawna powziętych, niezmiennych, prawdziwych; (Iz 25,1)",
    "Panie, użyczysz nam pokoju, bo i wszystkie nasze dzieła Tyś nam zdziałał! (Iz 26,12)",
    "Panie, zmiłuj się nad nami, w Tobie mamy nadzieję! Bądź naszym ramieniem każdego poranka i naszym zbawieniem w czas ucisku. (Iz 33,2)",
    "Pieśni mieć będziecie, jak przy obchodzie nocnej uroczystości, i radość serca jak u tego, co idzie przy dźwiękach fletu, zdążając na górę Pańską, ku Skale Izraela. (Iz 30,29)",
    "Po owocu bowiem poznaje się każde drzewo; nie zrywa się fig z ciernia ani z krzaka jeżyny nie zbiera się winogron. Dobry człowiek z dobrego skarbca swego serca wydobywa dobro, a zły człowiek ze złego skarbca wydobywa zło. Bo z obfitości serca mówią jego usta. (Łk 6,44-45)",
    "Po rozmowie z nimi Pan Jezus został wzięty do nieba i zasiadł po prawicy Boga. (Mk 16,19)",
    "Po sześciu dniach Jezus wziął z sobą Piotra, Jakuba i Jana i zaprowadził ich samych osobno na górę wysoką. Tam przemienił się wobec nich. Jego odzienie stało się lśniąco, tak jak żaden folusznik na ziemi wybielić nie zdoła. (Mk 9,2-3)",
    ...
    "Połamał Pan laskę złoczyńców i berło panujących, co smagało narody zajadle nieustannymi ciosami, co rządziło ludami z wściekłością, prześladując je bez miłosierdzia. (Iz 14,5-6)",
    ...
    "Ponad wszystkim jest Pan, bo mieszka na wysokości! Napełni On Syjon prawem i sprawiedliwością. I zawita trwały pokój w jego czasach. Zasobem sił zbawczych - mądrość i wiedza, jego skarbem jest bojaźń Pańska. (Iz 33,5-6)",
    "Ponieważ drogi jesteś w moich oczach, nabrałeś wartości i Ja cię miłuję, przeto daję ludzi za ciebie i narody za życie twoje. Nie lękaj się, bo jestem z tobą. (Iz 43,4-5a)",
    ...
    "Poślijcie baranka dla władcy krainy, drogą przez pustynię do góry Córy Syjonu! (Iz 16,1)",
    "Potem ukazał się w innej postaci dwom z nich na drodze, gdy szli do wsi. (Mk 16,12)",
    "Potomstwo Izraela, Jego sługi, synowie Izraela, Jego wybrańcy! On, Pan, jest naszym Bogiem, Jego wyroki obejmują świat cały. (1Krn 16,13-14)",
    "Pouczaj mnie, Panie bym Prawa Twego przestrzegał, a zachowywał je całym sercem. (Ps 119,34)",
    "Pouczam was o Bożej mocy, niczego nie taję o Wszechmocnym. (Hi 27,11)",
    "Powiecie w owym dniu: Chwalcie Pana! Wzywajcie Jego imienia! Rozgłaszajcie Jego dzieła wśród narodów, przypominajcie, że wspaniałe jest imię Jego! (Iz 12,4)",
    ...
    "Poznaj dzisiaj i rozważ w swym sercu, że Pan jest Bogiem, a na niebie wysoko i na ziemi nisko nie ma innego. Strzeż Jego praw i nakazów, które ja dziś polecam tobie pełnić; by dobrze ci się wiodło i twym synom po tobie; byś przedłużył swe dni na ziemi, którą na zawsze daje ci Pan, Bóg twój. (Pwt 4,39-40)",
    "Pożycza [samemu] Panu - kto dla biednych życzliwy, za dobrodziejstwo On mu nagrodzi. (Prz 19,17)",
    "Póki mego życia, chcę śpiewać Panu i grać mojemu Bogu, póki mi życia starczy. Niech miła Mu będzie pieśń moja, będę radował się w Panu. (Ps 104,33-34)",
    "Prawdziwi czciciele będą oddawać cześć Ojcu w Duchu i prawdzie, a takich to czcicieli chce mieć Ojciec. Bóg jest duchem: potrzeba więc, by czciciele Jego oddawali Mu cześć w Duchu i prawdzie, a takich to czcicieli chce mieć Ojciec. (J 4,23b-24)",
    "Prawego Bóg nie odrzuci, złego nie wzmocni ramieniem. Napełni twe usta radością, a wargi okrzykiem wesela. (Hi 8,20-21)",
    ...
    "Proście, a będzie wam dane; szukajcie, a znajdziecie; kołaczcie, a otworzą wam. Albowiem każdy, kto prosi, otrzymuje; kto szuka, znajduje; a kołaczącemu otworzą. (Mt 7,7-8)",
    "Prowadź mię Panie, ścieżką Twoich przykazań, bo ja się nimi raduję. (Ps 119,35)",
    ...
    "Przed Nim kroczą majestat i piękno, potęga i jasność w Jego przybytku. Oddajcie Panu, rodziny narodów, oddajcie Panu chwałę i potęgę, oddajcie Panu chwałę Jego imienia. (1Krn 16,27-29a)",
    "Przeto czy jecie, czy pijecie,czy cokolwiek innego czynicie, wszystko na chwałę Bożą czyńcie. (1 Kor 10,31)",
    "Przeto lud mocny Cię chwali, miasto narodów przemożnych czci Ciebie. (Iz 25,3)",
    ...
    "Przez czterdzieści lat zaopatrywałeś ich na pustyni, tak że nie odczuwali braku. Szaty ich się nie zniszczyły, a nogi ich nie spuchły. (Ne 9,21)",
    "Przez to miłość osiąga w nas kres doskonałości, że mamy pełną ufność na dzień sądu, ponieważ tak, jak On jest [w niebie], i my jesteśmy na tym świecie. (1J 4,17)",
    ...
    "Przyjdzie do tego wówczas, kiedy Pan da ci pokój po twych cierpieniach i kłopotach, i po twardej niewoli, którą cię przytłoczono, że rozpoczniesz tę satyrę na króla babilońskiego i powiesz: «O, jakże nadszedł kres ciemięzcy! Jak ustała jego zuchwałość! (Iz 14,3-4)",
    ...
    "Przystąpcie, narody, by słuchać! I wy, ludy, natężcie uwagę! Niech słucha ziemia i wszystko, co ją napełnia, świat i wszystko, co na nim wyrasta! (Iz 34,1)",
    "Przywrócę twoich sędziów jak dawniej, i twoich radnych jak na początku. Wówczas cię nazwą: Miastem Sprawiedliwości, Grodem Wiernym». (Iz 1,26)",
    "Radosnego dawcę miłuje Bóg. (2Kor 9,7b)",
    ...
    "Radujcie się zawsze w Panu; jeszcze raz powtarzam: radujcie się! Niech będzie znana wszystkim ludziom wasza wyrozumiała łagodność: Pan jest blisko! (Flp 4,4-5)",
    "Raduje się me serce w Panu, moc moja wzrasta dzięki Panu, rozwarły się me usta na wrogów moich, gdyż cieszyć się mogę Twoją pomocą. Nikt tak święty jak Pan, prócz Ciebie nie ma nikogo, nikt taką Skałą jak Bóg nasz. (1 Sm 2,1b-2)",
    ...
    "Rozważajcie o Panu i Jego potędze, szukajcie zawsze Jego oblicza: Pamiętajcie o cudach, które On zdziałał, o Jego znakach i sądach ust Jego. (1Krn 16,11-12)",
    "Rozważny zło widzi i odwraca się, nierozważni tam idą - i szkodę ponoszą. Owocem pokory jest bojaźń Pańska, bogactwo, szacunek i życie. (Prz 22,3-4)",
    "Sam Duch wspiera swym świadectwem naszego ducha, że jesteśmy dziećmi Bożymi. Jeżeli zaś jesteśmy dziećmi, to i dziedzicami Boga, a współdziedzicami Chrystusa; skoro wspólnie z Nim cierpimy, to po to, by wspólnie mieć udział w chwale. (Rz 8,16-17)",
    "Sam Duch wspiera swym świadectwem naszego ducha, że jesteśmy dziećmi Bożymi. Jeżeli zaś jesteśmy dziećmi, to i dziedzicami: dziedzicami Boga, a współdziedzicami Chrystusa, skoro wspólnie z Nim cierpimy po to, by też wspólnie mieć udział w chwale. (Rz 8,17)",
    "Skąd więc pochodzi mądrość i gdzie jest siedziba wiedzy? Zakryta dla oczu żyjących, i ptakom powietrznym nieznana. Podziemie i Śmierć oświadczają: \"Nie doszło tu echo jej sławy. Droga tam Bogu wiadoma, On tylko zna jej siedzibę; On przenika krańce ziemi, bo widzi wszystko, co jest pod niebem;\" (Hi 28,20-24)",
    ...
    "Słowo Twe, Panie, trwa na wieki, niezmienne jak niebiosa. Wierność Twoja trwa z pokolenia na pokolenie; umocniłeś ziemię, i trwa. (Ps 119,89-90)",
    "spieczona ziemia zmieni się w pojezierze, spragniony kraj w krynice wód; badyle w kryjówkach, gdzie legały szakale - na trzcinę z sitowiem. Będzie tam droga czysta, którą nazwą Drogą Świętą. Nie przejdzie nią nieczysty, <gdy odbywa podróż>, i głupi nie będą się tam wałęsać. (Iz 35,7-8)",
    ...
    "Sprawcie sobie trzosy, które nie niszczeją, skarb niewyczerpany w niebie, gdzie złodziej się nie dostaje ani mól nie niszczy. Bo gdzie jest skarb wasz, tam będzie i serce wasze. (Łk 12,33-34)",
    ...
    "Stróż odrzekł: «Przychodzi ranek, a także noc. Jeśli chcecie pytać, pytajcie, nawróćcie się, przyjdźcie!» (Iz 21,12)",
    "Strzeż mojej duszy i wybaw mnie, bym się nie zawiódł, gdy się uciekam do Ciebie. Niechaj mnie chronią niewinność i prawość, bo w Tobie, Panie, pokładam nadzieję. (Ps 25,20-21)",
    ...
    "Szczęśliwy, komu pomocą jest Bóg Jakuba, kto ma nadzieję w Panu, Bogu swoim, który stworzył niebo i ziemię, i morze ze wszystkim, co w nich istnieje. On wiary dochowuje na wieki (Ps 146,5-6)",
    "Szczyćcie się Jego świętym imieniem; niech się weseli serce szukających Pana! Rozmyślajcie o Panu i Jego potędze, szukajcie zawsze Jego oblicza! (Ps 105,3-4)",
    "Szlachetny zaś człowiek zamierza rzeczy szlachetne i trwa statecznie w szlachetnym działaniu. (Iz 32,8)",
    "Szukaj rady u każdego mądrego i nie gardź żadną pożyteczną radą. W każdej chwili uwielbiaj Pana Boga i proś Go, aby drogi twoje były proste i aby doszły do skutku wszystkie twoje zamiary i pragnienia, ponieważ żaden naród nie posiada mądrości, lecz wszystko, co dobre, daje sam Pan (Tb 4,18-19a)",
    ...
    "Śpiewajcie Panu, bo uczynił wzniosłe rzeczy! Niech to będzie wiadome po całej ziemi! (Iz 12,5)",
    "Śpiewajcie Panu, bo uczynił wzniosłe rzeczy! Niech to będzie wiadome po całej ziemi! (Iz 12,5)",
    "Śpiewajcie Panu, wszystkie krainy, z dnia na dzień głoście Jego zbawienie! Rozgłaszajcie Jego chwałę wśród pogan, Jego cuda – wśród wszystkich narodów (1Krn 16,23-24)",
    "Światło wschodzi7 dla sprawiedliwego i radość dla ludzi prawego serca. Sprawiedliwi, weselcie się w Panu i wysławiajcie Jego święte imię! (Ps 97,11-12)",
    "Światłość Izraela stanie się ogniem, a Święty jego - płomieniem, który pożre i pochłonie jego ciernie i jego głogi w jednym dniu (Iz 10,17)",
    "Tak bowiem Bóg umiłował świat, że Syna swego Jednorodzonego dał, aby każdy, kto w Niego wierzy, nie zginął, ale miał życie wieczne. (J 3,16)",
    "Tak jak ciało bez ducha jest martwe, tak też jest martwa wiara bez uczynków. (Jk 2,26)",
    "Tak możecie przejść myślą jedno pokolenie po drugim i przekonacie się, że nie zawiedzie się ten, kto w Nim /Bogu/ pokłada swe nadzieje. (1Mch 2,61)",
    ...
    "Tak, tak, Boże ojca mego, Boże dziedzictwa Izraela, Władco nieba i ziemi, Stwórco wód i Królu wszelkiego stworzenia, wysłuchaj modlitwy mojej! (Jdt 9,12)",
    "Także na ścieżce Twoich sądów, o Panie, my również oczekujemy Ciebie; imię Twoje i pamięć o Tobie to upragnienie duszy. (Iz 26,8)",
    ...
    "Teraz błogosławcie Boga całego stworzenia, który wszędzie czyni wielkie rzeczy, który od łona matczynego wywyższa dni nasze, który z nami postępuje według swego miłosierdzia. (Syr 50,22)",
    ...
    "To również pochodzi od Pana Zastępów, który przedziwny okazał się w radzie, niezmierzony w mądrości. (Iz 28,29)",
    "Toteż wina Jakuba przez to będzie zmazana; i ten będzie cały owoc usunięcia jego grzechu; wszystkie kamienie ołtarza przeznaczy on na pokruszenie jak kamienie wapienne. Nie będą stać już aszery ni stele słoneczne (Iz 27,9)",
    ...
    "Twoja łaska, Panie, napełnia ziemię: naucz mnie Twoich ustaw! (Ps 119,64)",
    "Twoje napomnienia są przedziwne, dlatego przestrzega ich moja dusza. Przystępność Twoich słów oświeca i naucza niedoświadczonych. (Ps 119,129-130)",
    "Twoje napomnienia są przedziwne, dlatego przestrzega ich moja dusza. Przystępność Twoich słów oświeca i naucza niedoświadczonych. (Ps 119,129-130)",
    "Twoje słowo jest lampą dla moich stóp i światłem na mojej ścieżce. (Ps 119,105)",
    "Ty bowiem jesteś dla mnie skałą i twierdzą; przez wzgląd na imię Twoje kieruj mną i prowadź mnie! Wydobądź mnie z sieci zastawionej na mnie, bo Ty jesteś moją ucieczką. (Ps 31,4-5)",
    "Ty jesteś moją pomocą, więc mnie nie odrzucaj i nie opuszczaj mnie, Boże, moje Zbawienie! Choćby mnie opuścili ojciec mój i matka, to jednak Pan mnie przygarnie. (Ps 27,9b-10)",
    "Ty ogarniasz mnie zewsząd i kładziesz na mnie swą rękę. (Ps 139,5)",
    "Ty w wielkim miłosierdziu twoim nie opuściłeś ich na pustyni. Słup obłoku nie odstępował od nich we dnie, aby ich prowadzić drogą; słup ognia nie odstępował w nocy, aby oświetlać im drogę, którą iść mieli. (Ne 9,19)",
    "Ty zaś, gdy chcesz się modlić, wejdź do swej izdebki, zamknij drzwi i módl się do Ojca twego, który jest w ukryciu. A Ojciec twój, który widzi w ukryciu, odda tobie. (Mt 6,6)",
    "Ty, Panie, jesteś jedyny. Ty uczyniłeś niebiosa, niebiosa niebios i całe ich wojsko; ziemię i wszystko, co na niej; morza i wszystko, co w nich. Ty ożywiasz to wszystko, a wojsko niebios oddaje Ci pokłon. (Ne 9,6)",
    "Tyś stworzył Adama, i stworzyłeś dla niego pomocną ostoję – Ewę, Jego żonę, i z obojga powstał rodzaj ludzki. I Ty rzekłeś: Nie jest dobrze, być człowiekowi samemu, uczyńmy u pomocnicę podobną do niego. (Tb 8,6)",
    "U was zaś nawet włosy na głowie wszystkie są policzone. Nie bójcie się: jesteście ważniejsi niż wiele wróbli. (Łk 12,7)",
    "Uderzcie w bębny na cześć mojego Boga, zagrajcie Panu na cymbałach, zanućcie Mu psalm i pieśń uwielbienia, wysławiajcie w wzywajcie Jego imię! (Jdt 16,1)",
    "Ufaj Panu i wytrwaj w twym trudzie, albowiem łatwą jest rzeczą w oczach Pana natychmiast i niespodziewanie wzbogacić ubogiego. (Syr 11,21b)",
    "Ufaj Panu, bądź mężny, niech się twe serce umocni, ufaj Panu! (Ps 27,14)",
    "Ufność, którą w Nim /Bogu/ pokładamy, polega na przekonaniu, że wysłuchuje On wszystkich naszych próśb zgodnych z Jego wolą. A jeśli wiemy, że wysłuchuje wszystkich naszych próśb, pewni jesteśmy również posiadania tego, o cośmy prosili. (1J 5,14-15)",
    "Ufność, którą w Nim pokładamy, polega na przekonaniu, że wysłuchuje On wszystkich naszych próśb zgodnych z Jego wolą. jeśli wiemy, że wysłuchuje wszystkich naszych próśb, pewni jesteśmy również posiadania tego, o cośmy Go prosili. (1J 5,14-15)",
    ...
    "Umiłowani, obecnie jesteśmy dziećmi Bożymi, ale jeszcze się nie ujawniło, czym będziemy. Wiemy, że gdy się objawi, będziemy do Niego podobni, bo ujrzymy Go takim, jakim jest. Każdy zaś, kto pokłada w Nim tę nadzieję, uświęca się podobnie jak On jest święty. (1J 3,2-3)",
    ...
    "Upodoba sobie w bojaźni Pańskiej. Nie będzie sądził z pozorów ni wyrokował według pogłosek; raczej rozsądzi biednych sprawiedliwie i pokornym w kraju wyda słuszny wyrok. Rózgą swoich ust uderzy gwałtownika, tchnieniem swoich warg uśmierci bezbożnego. (Iz 11,3-4)",
    ...
    "Uwaga! Gwar na górach, jakoby tłumu mnogiego. Uwaga! Wrzawa królestw, sprzymierzonych narodów. To Pan Zastępów robi przegląd wojska do bitwy. (Iz 13,4)",
    "Uważaj na siebie, dziecko, we wszystkich swoich uczynkach i bądź dobrze wychowany w całym swoim postępowaniu! Czym sam się brzydzisz, nie czyń tego nikomu! (Tb 4,14b-15a)",
    "Uważaj na siebie, dziecko, we wszystkich swoich uczynkach i bądź dobrze wychowany w całym swoim postępowaniu! Czym sam się brzydzisz, nie czyń tego nikomu! (Tb 4,14b-15a)",
    ...
    "Uznaj w sercu, że jak wychowuje człowiek swego syna, tak Pan, Bóg twój, wychowuje ciebie. Strzeż więc nakazów Pana, Boga twego, chodząc Jego drogami, by żyć w bojaźni przed Nim. (Pwt 8,5-6)",
    ...
    "W Bogu uwielbiam Jego słowo, Bogu ufam, nie będę się lękał: cóż może mi uczynić człowiek? (Ps 56,5)",
    "W Bogu uwielbiam Jego słowo, wielbię słowo Pana. Bogu ufam, nie będę się lękał: cóż może mi uczynić człowiek? (Ps 56,11-12)",
    "W każdym czasie Jemu ufaj, narodzie! Przed Nim serca wasze wylejcie: Bóg jest dla nas ucieczką! (Ps 62,9)",
    "W każdym położeniu bierzcie wiarę jako tarczę, dzięki której zdołacie zgasić wszystkie pociski Złego. (Ef 6,16)",
    "W każdym położeniu bierzcie wiarę jako tarczę, dzięki której zdołacie zgasić wszystkie rozżarzone pociski Złego. Weźcie też hełm zbawienia i miecz Ducha, to jest słowo Boże - wśród wszelakiej modlitwy i błagania. Przy każdej sposobności módlcie się w Duchu! (Ef 6,16-18a)",
    ...
    "W owym dniu patrzeć będzie człowiek na swego Stwórcę i jego oczy się zwrócą ku Świętemu Izraela. (Iz 17,7)",
    "W owym dniu Reszta z Izraela i ocaleni z domu Jakuba nie będą więcej polegać na tym, który ich bije, ale prawdziwie oprą się na Panu, Świętym Izraela. (Iz 10,20)",
    "W ów dzień [powiedzą]: Winnica urocza! Śpiewajcie o niej! Ja, Pan, jestem jej stróżem; podlewam ją co chwila, by jej co złego nie spotkało, strzegę jej w dzień i w nocy. (Iz 27,2-3)",
    "W ów dzień spadnie ci z pleców jego brzemię i jego jarzmo z szyi. (Iz 10,27)",
    "W ów dzień śpiewać będą tę pieśń w Ziemi Judzkiej: «Miasto mamy potężne; On jako środek ocalenia sprawił mury i przedmurze. (Iz 26,1)",
    "W ów dzień zagrają na wielkiej trąbie, i wtedy przyjdą zagubieni w kraju Asyrii i rozproszeni po kraju egipskim, i uwielbią Pana na świętej górze, w Jeruzalem (Iz 27,13)",
    "W przyszłości Jakub się zakorzeni, Izrael zakwitnie i rozrośnie się, i napełni powierzchnię ziemi owocami. (Iz 27,6)",
    "W roku śmierci króla Ozjasza ujrzałem Pana siedzącego na wysokim i wyniosłym tronie, a tren Jego szaty wypełniał świątynię. Serafiny stały ponad Nim; każdy z nich miał po sześć skrzydeł; dwoma zakrywał swą twarz, dwoma okrywał swoje nogi, a dwoma latał. I wołał jeden do drugiego: «Święty, Święty, Święty jest Pan Zastępów. Cała ziemia pełna jest Jego chwały». (Iz 6,1-3)",
    "W rzeczywistości jest Bóg niedaleko od każdego z nas.Bo w Nim żyjemy, poruszamy się i jesteśmy. (Dz 17,27b-28)",
    "W rzeczywistości jest On /Bóg/ niedaleko od każdego z nas. Bo w Nim żyjemy, poruszamy się i jesteśmy. (Dz 17,27b-28)",
    ...
    "Walcz w dobrych zawodach o wiarę, zdobądź życie wieczne: do niego zostałeś powołany. (1 Tym 6,12a)",
    "Wchodźcie przez ciasną bramę! Bo szeroka jest brama i przestronna ta droga, która prowadzi do zguby, a wielu jest takich, którzy przez nią wchodzą. Jakże ciasna jest brama i wąska droga, która prowadzi do życia, a mało jest takich, którzy ją znajdują! (Mt 7,13-14)",
    "We łzach rozpływa się dusza, zgnębiły mnie dni niedoli. (Hi 30,16)",
    "Wejdźcie, uwielbiajmy, padnijmy na twarze i zegnijmy kolana przed Panem, który nas stworzył. Albowiem On jest naszym Bogiem, a my ludem Jego pastwiska i owcami w Jego ręku. (Ps 95,6-7a)",
    ...
    "Wiecie bowiem, że z waszego, odziedziczonego po przodkach, złego postępowania zostali wykupieni nie czymś przemijającym, srebrem lub złotem, ale drogocenną krwią Chrystusa, jako baranka niepokalanego i bez zmazy. (1P 1,18-19)",
    ...
    "Wiedzcie, że Pan jest Bogiem: On sam nas stworzył, my Jego własnością, jesteśmy Jego ludem, owcami Jego pastwiska.[...] Albowiem dobry jest Pan, łaskawość Jego trwa na wieki, a wierność Jego przez pokolenia. (Ps 100,3-5)",
    "Wiele nieszczęść spada na sprawiedliwego; lecz ze wszystkich Pan go wybawia. (Ps 34,20)",
    "Wiele Ty uczyniłeś swych cudów, Panie, Boże mój, a w zamiarach Twoich wobec nas nikt Ci nie dorówna. I gdybym chciał je wyrazić i opowiedzieć, będzie ich więcej niżby można zliczyć. (Ps 40,6)",
    "Wielki jest Bóg w swej wszechmocy, któż takim mistrzem jak On? Kto Jego drogę chce zganić? Kto powie: «Źle uczyniłeś»? (Hi 36,22-23)",
    ...
    "Wiemy także, że Syn Boży przyszedł i obdarzył nas zdolnością rozumu, abyśmy poznawali Prawdziwego. Jesteśmy w prawdziwym Bogu, w Synu Jego, Jezusie Chrystusie. On zaś jest prawdziwym Bogiem i Życiem wiecznym. Dzieci, strzeżcie się fałszywych bogów! (1J 5,20-21)",
    "Więcej szczęścia jest w dawaniu, aniżeli w braniu (Dz 20,35b)",
    "Wobec zamieszania, płaczu i głośnego zawodzenia, wszedł i rzekł do nich: \"Czemu robicie zgiełk i płaczecie? Dziecko nie umarło, tylko śpi\". (Mk 5,38b-39)",
    "Wpadnijmy raczej w ręce Pana niż w ręce ludzi: jaka jest bowiem Jego wielkość, takie też i miłosierdzie. (Syr 2,18)",
    "Wreszcie zostanie wylany na nas Duch z wysokości. Wtedy pustynia stanie się sadem, a sad za las uważany będzie. Na pustyni osiądzie prawo, a sprawiedliwość zamieszka w sadzie. (Iz 32,15-16)",
    "Wszechmocny jest – któż Go dosięże? Pełen potęgi, świętości, bogaty w prawość, nie w ucisk. (Hi 37,23)",
    "Wszechmocny twą sztabą złota i srebrem błyszczącym dla ciebie. Nadzieją twą będzie Wszechmocny, obrócisz wzrok twój na Boga, wezwiesz Go, a On cię wysłucha. (Hi 22,25-27a)",
    "Wszechmocny twą sztabą złota i srebrem błyszczącym dla ciebie. (Hi 22,25)",
    "Wszyscy zaś wobec siebie wzajemnie przyobleczcie się w pokorę, Bóg bowiem pysznym się sprzeciwia, a pokornym łaskę daje. Upokórzcie się więc pod mocną ręką Boga, aby was wywyższył w stosownej chwili. (1P 5,5b-6)",
    "Wszystkie dzieła Pana są dobre, w odpowiedniej chwili dostarcza On wszystkiego, czego potrzeba. Nie można mówić: «To od tamtego gorsze», albowiem wszystko uznane będzie za dobre w swoim czasie. A teraz ustami i z całego serca śpiewajcie i wychwalajcie imię Pana! (Syr 39,33-35)",
    ...
    "Wszystkie troski wasze przerzućcie na Niego /Boga/, gdyż Jemu zależy na was. (1P 5,7)",
    "Wszystkie wasze sprawy niech się dokonują w miłości! (1Kor 16,14)",
    "Wszystkim we wszystkich jest Chrystus (Kol 3,11b)",
    ...
    "Wszystko przez Niego i dla Niego zostało stworzone. On jest przed wszystkim i wszystko w Nim ma istnienie. I On jest Głową Ciała – Kościoła. (Kol 1,16b-18a)",
    "Wszystko więc, co byście chcieli, żeby wam ludzie czynili, i wy im czyńcie! (Mt 7,12)",
    "Wszystko wolno, ale nie wszystko przynosi korzyść. Wszystko wolno, ale nie wszystko buduje. Niech nikt nie szuka własnego dobra, lecz dobra bliźniego! (1Kor 10,23-24)",
    "Wśród ludów będę chwalił Cię, Panie; zagram Ci wśród narodów, bo Twoja łaskawość aż do niebios, a wierność Twoja po chmury! (Ps 57,10-11)",
    "Wtedy Duch wyprowadził Jezusa na pustynię, aby był kuszony przez diabła. (Mt 4,1)",
    "Wtedy dziękowali Bogu niebios i mówili: Bądź uwielbiony, Boże, wszelkim czystym uwielbieniem! Niech Cię wielbią po wszystkie wieki. Bądź uwielbiony, ponieważ mnie ucieszyłeś i nie stało się, jak przypuszczałem. Postąpiłeś z nami według wielkiego Twego miłosierdzia. (Tb 8,16)",
    ...
    "Wtedy przejrzą oczy niewidomych i uszy głuchych się otworzą. Wtedy chromy wyskoczy jak jeleń i język niemych wesoło krzyknie. Bo trysną zdroje wód na pustyni i strumienie na stepie; (Iz 35,5-6)",
    ...
    "Wy bowiem jesteście przez wiarę strzeżeni mocą Bożą dla zbawienia, gotowego objawić się w czasie ostatecznym. Dlatego radujcie się, choć teraz musicie doznać trochę smutku z powodu różnorodnych doświadczeń. (1P 1,5-6)",
    ...
    "Wy, choć nie widzieliście, miłujecie Go; wy w Niego teraz, choć nie widzicie, przecież wierzycie, a ucieszycie się radością niewymowną i pełną chwały wtedy, gdy osiągniecie cel waszej wiary - zbawienie dusz. (1P 1,8-9)",
    "Wykrzykujcie na cześć Pana, wszystkie ziemie; służcie Panu z weselem! Wśród okrzyków radości stawajcie przed Nim! (Ps 100,1b-2)",
    "wynieście wodę naprzeciw spragnionych! Mieszkańcy kraju Tema, z chlebem waszym wyjdźcie na spotkanie uchodźców! (Iz 21,14)",
    "Wyniosłe oczy człowieka się ukorzą i duma ludzka będzie poniżona. Sam tylko Pan się wywyższy dnia owego. (Iz 2,11)",
    "wypełnisz swoje śluby, zamiary swe przeprowadzisz. Na drodze twej światło zabłyśnie. (Hi 22,27b-28)",
    ...
    "Z Jego światłem kroczyłem w ciemności, gdym lata jesienne przeżywał, gdy Bóg osłaniał mój namiot. (Hi 29,3-4)",
    "Z ochotą służcie, jak gdybyście [służyli] Bogu, a nie ludziom, świadomi tego, że każdy - jeśli uczyni co dobrego otrzyma to z powrotem od Pana. (Ef 6,7-8a)",
    "Z pyłu podnosi biedaka, z barłogu dźwiga nędzarza, by go wśród możnych posadzić, by dać mu tron zaszczytny. Do Pana należą filary ziemi: na nich świat położył. (1Sm 2,8)",
    ...
    "Za pełną radość poczytujcie to sobie, bracia moi, ilekroć spadają na was różne doświadczenia. Wiedzcie, że to, co wystawia waszą wiarę na próbę, rodzi wytrwałość. Wytrwałość zaś winna być dziełem doskonałym, abyście byli doskonali, nienaganni, w niczym nie wykazując braków. (Jkb 1,2-4)",
    ...
    "Za wszystko wysławiaj Tego, który cię stworzył i który cię upaja swoimi dobrami. (Syr 32,13)",
    "Zachowaj mnie, Boże, bo chronię się u Ciebie, mówię Panu: «Tyś jest Panem moim; nie ma dla mnie dobra poza Tobą». (Ps 16,1-2)",
    "Zaiste jeden dzień w przybytkach Twoich lepszy jest niż innych tysiące; wolę stać w progu domu mojego Boga, niż mieszkać w namiotach grzeszników. Bo Pan Bóg jest słońcem i tarczą: Pan hojnie darzy łaską i chwałą, nie odmawia dobrodziejstw postępującym nienagannie. (Ps 84,11-12)",
    "Zaiste Jeruzalem upada i Juda się wali, bo przeciw Panu są ich słowa i czyny, by oczy Jego chwały obrażać. (Iz 3,8)",
    ...
    "Zaiste, o ludu, który zamieszkujesz Syjon w Jerozolimie, nie będziesz gorzko płakał. Rychło okaże ci On łaskę na głos twojej prośby. Ledwie usłyszy, odpowie ci. Choćby ci dał Pan chleb ucisku i wodę utrapienia, twój Nauczyciel już nie odstąpi, ale oczy twoje patrzeć będą na twego Mistrza. Twoje uszy usłyszą słowa rozlegające się za tobą: «To jest droga, idźcie nią!», gdybyś zboczył na prawo lub na lewo. (Iz 30,19-21)",
    "Zaiste, podobnie jak ulewa i śnieg spadają z nieba i tam nie powracają, dopóki nie nawodnią ziemi, nie użyźnią jej i nie zapewnią urodzaju, tak iż wydaje nasienie dla siewcy i chleb dla jedzącego, tak słowo, które wychodzi z ust moich, nie wraca do Mnie bezowocne, zanim wpierw nie dokona tego, co chciałem, i nie spełni pomyślnie swego posłannictwa. (Iz 55,10-11)",
    "Zaiste, tak wyrzekł Pan do mnie, gdy Jego ręka mocno mnie ujęła, by mnie odwrócić od postępowania drogą tego ludu [...] (Iz 8,11)",
    "Zaprawdę, powiadam wam: Jeśli będziecie mieć wiarę jak ziarnko gorczycy, powiecie tej górze: «Przesuń się stąd tam!», a przesunie się. I nic niemożliwego nie będzie dla was. (Mt 17,20b)",
    ...
    "Zaprawdę, zaprawdę, powiadam wam: Kto we Mnie wierzy, będzie także dokonywał tych dzieł, których Ja dokonuję, owszem, i większe od tych uczyni, bo Ja idę do Ojca. A o cokolwiek prosić będziecie w imię moje, to uczynię, aby Ojciec był otoczony chwałą w Synu. (J 14,12-13)",
    "Zaprawdę, zaprawdę, powiadam wam: o cokolwiek byście prosili Ojca, da wam w imię moje. (J 16,23b)",
    ...
    "Zboże mogłoby ulec zmiażdżeniu; ale nie bez końca młóci je młockarz. Gdy przetoczy koło swego wozu młockarskiego wraz z zaprzęgiem, nie zmiażdży go. (Iz 28,28)",
    ...
    "Złodziej przychodzi tylko po to, aby kraść, zabijać i niszczyć. Ja /Jezus/ przyszedłem po to, aby [owce] miały życie i miały je w obfitości. (J 10,10)",
    ...
    "Złóżcie należne ofiary i miejcie w Panu nadzieję! (Ps 4,6)",
    "Znam cię po imieniu i jestem ci łaskawy. (Wj 33,12b)",
    "Zrzuć swą troskę na Boga, a On cię podtrzyma; nie dopuści nigdy, by miał się zachwiać sprawiedliwy. (Ps 55,23)",
    "Żaden, kto wierzy w Niego /Boga/ nie będzie zawstydzony. (Iz 28,16)"
